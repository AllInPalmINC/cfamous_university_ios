...
define(function(require, exports, module) {
    ...
    function _createItems() {
        var self = this;
        var f = function (optionsItem){
            _addMenuItem.call(self, optionsItem);
        };
    ...
    function _animateItems() {
        ...
        this._itemMods.forEach(function(posModifier, index) {
            ...
            var coords = {
                x: this.active ? this.options.radius *
                 Math.cos(this.options.startRotation + offset) : 0,
                y: this.active ? this.options.radius *
                 Math.sin(this.options.startRotation + offset) : 0
            };
    ...
    function _addMenuItem(optionsItem) {
        var item = new MenuItemView();
        ...
        item.on('click', function(){
            var callback = optionsItem.callback;
